...
//MC602兼容老款MC601的传感器
#define    JOYSTICK_IIC_Addr            0x2c //摇杆传感器
#define    IIR_IIC_Addr                 0x15 //红外遥控模块IIC地址
#define    MPU6500_IIC_Addr			    0x69//纯硬件陀螺IIC地址
...
struct DMP
{
    ...
    int mpu_addr_type; //指示是带CPU协议转接的陀螺，还是纯硬件陀螺
};

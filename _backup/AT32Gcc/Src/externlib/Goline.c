...
__IO static int GrayType = FiveGray;
__IO static int Port = P5;
...
__IO static int hb1 = 0;
__IO static int hb2 = 0;
__IO static int hb3 = 0;
__IO static int hb4 = 0;
__IO static int hb5 = 0;
__IO static int hb6 = 0;
__IO static int hb7 = 0;
__IO static int hb8 = 0;
__IO static int hb9 = 0;
__IO static int hb10 = 0;
int checkGrayPort();
void patr_environmental_acquiment(void)
{
    ...
    wait(1.0);
    linebeep();
    Printf("Done\nBlack=%d %d %d %d %d\nWhite=%d %d %d %d %d", hb1, hb2, hb3, hb4, hb5, hb6, hb7, hb8, hb9, hb10);
    ...
    /*while (true)
    {
		...
		Printf("PORT=%d,GrayType=%d\n%d,%d,%d,%d,%d",Port,GrayType,
                                hb6,
								hb7,
								hb8,
								hb9,
...
int checkGrayPort()
{
    ...
    //是否是5灰度
    wait(0.005);
    Reset5GrayConnect(iPort);
    get_integrated_grayscale(iPort,GRAY_CH1);
    wait(0.05);
    if(Is5GrayConnect(iPort) == true)
    {
        //端口1上连接了5灰度
        return iPort;
    }
...
static void motor_ds(int dj_a, int dj_b, int ds)
{
...
static void motor_sensor(int dj_a, int dj_b, int s_id, int a, int s)
{
   if(wheel==0)
   {
			  dj_a=Pow_a*dj_a/100;

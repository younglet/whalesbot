...
/*
SPI1(REMAP)
PA15(JTDI)  SPI1_NSS 针对602控制器，此管脚等效于液晶使能管脚
PB3(JTDO)   SPI1_SCK
PB4(JNRST)  SPI1_MISO
PB5         SPI1_MOSI
*/
...
#define SPIFLASH        SPI1
    ...
    #define SPI_BUAD_DIV SPI_BaudRatePrescaler_8//SPI_BaudRatePrescaler_64//SPI_BaudRatePrescaler_128// 240/128=1.8M
#endif
#ifdef  SYSCLK_FREQ_180MHz
    #define SPI_BUAD_DIV SPI_BaudRatePrescaler_2//SPI_BaudRatePrescaler_64//SPI_BaudRatePrescaler_128// 240/128=1.8M
#endif

...
#define FLASH_INTERNAL_BANK1  FLASH_BASE+(512*1024)//bank1最小从512K开始
//602内部1M
#define FLASH_INTERNAL_MAX  FLASH_BASE+(1024*1024)//最大(1024)K
...
#define EEPROM_BATTTYPE     520//指示电池种类
#define EEPROM_AUTORUN      521//指示是否自动运行程序
/*
dummy                       519~529
*/
